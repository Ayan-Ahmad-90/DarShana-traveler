    ...
    <div className="min-h-screen bg-gray-900 text-white pb-20">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button onClick={() => window.location.href = "tel:100"} className="bg-gray-800 p-4 rounded-xl flex flex-col items-center gap-2 hover:bg-gray-700 transition-colors">
            <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400">
              <Shield className="w-6 h-6" />
            </div>
            <span className="font-medium">Police (100)</span>
          </button>
          <button onClick={() => window.location.href = "tel:102"} className="bg-gray-800 p-4 rounded-xl flex flex-col items-center gap-2 hover:bg-gray-700 transition-colors">
            <div className="w-10 h-10 rounded-full bg-red-500/20 flex items-center justify-center text-red-400">
              <Heart className="w-6 h-6" />
            </div>
            <span className="font-medium">Ambulance (102)</span>
          </button>
